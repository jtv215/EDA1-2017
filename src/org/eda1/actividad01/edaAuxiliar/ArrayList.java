...
package org.eda1.actividad01.edaAuxiliar;
...
public void trimToSize()
   ...
   public Object[] toArray()
   {
		...
		throws java.io.IOException
	{
		...
		out.writeInt(listArr.length);// escribimos el tamaño de la linea
		//Object Serialización
		...
		throws IOException, ClassNotFoundException
	{
		...
		//ESCRIBIR CODIGO AQUI
		//TODO
		//Array initialization from a given size
		listArr=(T[]) new Object[in.readInt()];//creo un  array con el tamaó que me pasan
		//obtject desrializacion
		for( int i=0; i<this.listSize;i++){
